        ...
        <div id="main">
            <section className="project">
                <Container>
                    ...
                    <Container className='py-3' style={{ display: 'flex' }}>
                        ...
                        <Container>
                            <Image src="/images/careworkshop.jpg" alt="Several hands place sticky notes on a table at a PD workshop" style={{ height: '250px', width: '250px' }}/>
                        </Container>
                    </Container>
